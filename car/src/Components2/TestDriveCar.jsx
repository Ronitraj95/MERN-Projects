...
const TestDriveCar = ({ data, tab, setTab }) => {
  return (
    <div className="p-6">
      <h2 className="text-3xl font-bold text-red-600 mb-6">My Test Drivers</h2>
          ...
          car && (
            ...
            >
              ...
              <div className="flex flex-col justify-between p-4 flex-1">
                ...
                <div className="mt-4">
               <Link to="/home">   <button className="bg-blue-600 text-white py-2 px-6 rounded-md hover:bg-blue-700">
                    View Details
                  </button></Link>
                </div>
              </div>
